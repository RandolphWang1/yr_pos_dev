...
int dc_HL_initval(int icdev,unsigned char _Mode,unsigned char _SecNr,unsigned long _Value,unsigned long *_Snr);
...
int dc_pro_command(int idComDev,unsigned char slen,
...
int dc_pro_commandhex(int idComDev,unsigned char slen,
									char * sendbuffer,unsigned char *rlen,
									char * databuffer,unsigned char timeout);
...
int dc_pro_commandlink(int idComDev,unsigned char slen,
								 ...
								 unsigned char * databuffer,unsigned char timeout,
								 unsigned char FG);
int dc_pro_commandlink_hex(int idComDev,unsigned char slen,
										 unsigned char * sendbuffer,unsigned char *rlen,
										 unsigned char * databuffer,unsigned char timeout,
										 unsigned char FG);

int dc_pro_reset_hex(int icdev,unsigned char *rlen, char *receive_data);
int dc_pro_command_hex(int idComDev,unsigned char slen, 
									 char * sendbuffer,unsigned char *rlen, 
									 char * databuffer,unsigned char timeout);
...
int dc_mfdes_auth_hex(int icdev,unsigned char keyno,unsigned char keylen,unsigned char *authkey,
									unsigned char *randAdata,unsigned char *randBdata);
int dc_authentication_passaddr(int icdev,unsigned char _Mode,
